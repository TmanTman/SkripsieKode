...
grid = calcGrid(X0, pump, geyser, PV_in, lights);
...
%Calculate the amount of energy pumped back into the grid
...
fprintf('Total amount of energy pumped back into grid: %d', sum(grid_pumped_back));
