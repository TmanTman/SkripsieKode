...
Query = '''SELECT Rating, DutyCycle, ID FROM loads WHERE Status = 1;'''
cur.execute(Query)
#Populate RsLoads with 3 rows: row0 is the rating, row1 is the dutycycle, row2 is the ID's
RsLoadsSelection = cur.fetchall()

for RsLoads in RsLoadsSelection:
